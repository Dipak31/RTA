...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //Chache Strokes
    var menStrokes : [Stroke] = [];
    var woMenStrokes : [Stroke] = [];
    var menWoMenStrokes : [Stroke] = [];

    //Set In-App purchase product to global so it can refresh in once time.
    var products = [SKProduct]()
    var productAllStroke : SKProduct? = nil
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if AppLifeState.getReceiptRefresh()!{
    ...
    func reachabilityChanged(note: NSNotification) {
        ...
        AlertUtil.showConnectivityAlert().show();
...
//        */
//        let container = NSPersistentContainer(name: "SMTP")
